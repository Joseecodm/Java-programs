...
public class Tres {
    ...
    public static void main(String[] args) {
        ...
        // Crea un array numérico con 5 elementos. Los números de cada elemento deben ser valores generados aleatoreamente entre 0 y 10. 
        ...
        for (int i = 0; i < 5; i++) {
            // Generar valores aleatorios entre 0 y 10 y asignarlos al array
